...
import '../../../game/achievements/milestone_progress.dart';
...
class MilestoneCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isUnlocked ? Colors.blueAccent.withAlpha(100) : Colors.white12,
          width: 1.5,
        ),
      ),
      child: Row(
            ...
            child: Column(
              ...
              children: [
                Text(
                  definition.titleKey,
                  style: TextStyle(
                    color: isUnlocked ? Colors.blueAccent : Colors.white,
                    fontSize: 16,
  ...
  Widget _buildIcon(bool isUnlocked) {
    return Container(
      ...
      height: 50,
      decoration: BoxDecoration(
        color: isUnlocked ? Colors.blueAccent.withAlpha(30) : Colors.black26,
