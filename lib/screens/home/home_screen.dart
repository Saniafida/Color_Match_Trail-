            ...
            children: [
              Expanded(
                child: _buildMiniGameCard(
                  ...
                  onPlay: () => Navigator.pushNamed(context, AppRoutes.challenges),
                ),
              ),
              const SizedBox(width: 5),
              Expanded(
                child: _buildMiniGameCard(
                  ...
                  onPlay: () => Navigator.pushNamed(context, AppRoutes.events),
                ),
              ),
              const SizedBox(width: 5),
              Expanded(
                child: _buildMiniGameCard(
                  ...
                  onPlay: () => Navigator.pushNamed(context, AppRoutes.gameplay, arguments: 'level_1'),
                ),
              ),
              const SizedBox(width: 5),
              Expanded(
                child: _buildMiniGameCard(
                  ...
                  onPlay: () => Navigator.pushNamed(context, AppRoutes.worldMap),
                ),
              ),
            ],
          ),
